...
# + ログファイルは image_gen.log.jsonl に統一
# ============================================================
...
# --------------------- ログ設定（JST, JSONL, app/page 自動付与） ---------------------
APP_DIR = Path(__file__).resolve().parents[1]
APP_NAME = APP_DIR.name                 # 例: image_maker_app
PAGE_NAME = Path(__file__).stem         # 例: 23_（新版）画像修正

LOG_DIR = APP_DIR / "logs"
LOG_DIR.mkdir(parents=True, exist_ok=True)
LOG_FILE = LOG_DIR / "image_gen.log.jsonl"   # ← ここを統一
